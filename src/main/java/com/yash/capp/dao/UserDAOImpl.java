...
public class UserDAOImpl extends  BaseDAO implements UserDAO
{
    ...
    public void save(User u) {
        ...
        Map m=new HashMap();
        m.put("name",u.getName()); //this bind with the name given by the user
        ...
        SqlParameterSource ps=new MapSqlParameterSource(m); //map based implementation
